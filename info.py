...
BOT_TOKEN = environ.get('BOT_TOKEN', "7156757667:AAEUQaaklWE2BYCWuZ_7_l0Hn_roOaqyxKI")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002205504138').split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vishalkumar259259:Pushpawithclone@cluster0.hqusq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # IF Multiple Database Is False Then Fill Only This Database Url.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Pushpawithclone")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://vishalkumar259259:Pushpawithclone@cluster0.hqusq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'hshdhhdhdhdhdhdg') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
